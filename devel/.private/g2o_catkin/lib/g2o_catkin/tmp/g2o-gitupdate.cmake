...
execute_process(
  COMMAND "/usr/bin/git" show-ref 1b118ac2ed2055c4016c3b7cbd710225ed1651af
  WORKING_DIRECTORY "/catkin_ws/devel/.private/g2o_catkin/lib/g2o_catkin/src/g2o"
...
if("${show_ref_output}" MATCHES "refs/remotes/1b118ac2ed2055c4016c3b7cbd710225ed1651af")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "1b118ac2ed2055c4016c3b7cbd710225ed1651af")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 1b118ac2ed2055c4016c3b7cbd710225ed1651af
  WORKING_DIRECTORY "/catkin_ws/devel/.private/g2o_catkin/lib/g2o_catkin/src/g2o"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/catkin_ws/devel/.private/g2o_catkin/lib/g2o_catkin/src/g2o/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/catkin_ws/devel/.private/g2o_catkin/lib/g2o_catkin/src/g2o/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/bin/git" checkout 1b118ac2ed2055c4016c3b7cbd710225ed1651af
      WORKING_DIRECTORY "/catkin_ws/devel/.private/g2o_catkin/lib/g2o_catkin/src/g2o"
      RESULT_VARIABLE error_code
      )
    if(error_code)
